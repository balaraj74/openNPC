...
class DQNPolicy:
    ...
    def export_onnx(self, path: str | Path) -> Path:
        """Export this DQN policy to ONNX format for dependency-free inference.

        Produces two files:
        - ``<path>``: the ONNX model (Q-network; outputs Q-values per action).
        ...
        try:
            ...
            import torch.onnx as _onnx  # noqa: F401
